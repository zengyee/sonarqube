...
public class MeasureFilterConditionTest {
  ...
  public void value_condition() {
    ...
    assertThat(condition.appendSqlCondition(new StringBuilder(), 1).toString()).isEqualTo(" pmcond1.metric_id=123 AND pmcond1.value > 10.0 AND pmcond1.rule_id IS NULL AND pmcond1.person_id IS NULL ");
  }
  ...
  public void variation_condition() {
    ...
    assertThat(condition.toString()).isNotEmpty();
    assertThat(condition.appendSqlCondition(new StringBuilder(), 2).toString()).isEqualTo(" pmcond2.metric_id=123 AND pmcond2.variation_value_3 <= 10.0  AND pmcond2.rule_id  AND pmcond2.person_id IS NULL ");
  }
  ...
  public void text_value_condition() {
    ...
    assertThat(condition.toString()).isNotEmpty();
    assertThat(condition.appendSqlCondition(new StringBuilder(), 1).toString()).isEqualTo(" pmcond1.metric_id=123 AND pmcond1.text_value = \"foo\" AND pmcond1.rule_id IS NULL AND pmcond1.person_id IS NULL ");
  }
}
